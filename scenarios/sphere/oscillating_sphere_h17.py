...
TimeStepping = {
	"InitialTime" : 0.0,
	"FinalTime" : 9.0,
	"NumTimeSteps" : 9*9*25*2  * 4, # 3*9*5*2,
	"TimeStepper" : "RK3SR",
}
...
Mesh = {
	"File" : f"../meshes/sphere_uniform_h17.msh",
}

Output = {
	"Prefix" : "sphere_h17p2", # mesh sphere_uniform2 (finer, smaller) @ 5 Hz: "sphere_5" # 5 Hz: "sphere_4"    # 10 Hz: "sphere_3",
	"WriteInterval" : 90,
