...
Mesh = {
	"File" : f"../meshes/sphere_uniform_h24.msh",
}

Output = {
	"Prefix" : "sphere_h24p1", # mesh sphere_uniform2 (finer, smaller) @ 5 Hz: "sphere_5" # 5 Hz: "sphere_4"    # 10 Hz: "sphere_3",
	"WriteInterval" : 239,
