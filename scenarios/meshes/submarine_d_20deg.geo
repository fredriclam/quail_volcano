...
dx = 200;      // Pointwise dx control
// Box dx control
dx_L1 = 25; // Refinement x2 // 75;     // In-box (region of interest) dx control -- chamber, dike
dx_L2 = 25; // Refinement ~ // 150;   // Transition level 1

r1 = 2500; // Domain size

conduit_length = 75;
conduit_radius = 79.59553513993035;
// Tangents
// tan 20 deg = 0.36397023426
// tan 15 deg = 0.26794919243
// tan 10 deg = 0.1763269807
crater_lip_radius = conduit_radius + 100 * 0.36397023426; // tan 20 deg
crater_depth = 100;
...
Point(7) = {conduit_radius, -crater_depth, 0, dx}; // Bottom outer point of conduit
Point(8) = {0, -crater_depth, 0, dx};    // Origin (along symmetry axis)
...
Field[4] = MathEval;
Field[4].F = Sprintf("((F3/100)^2 + 1) * %g", dx_L1);
...
Save "submarine_atmosphere20.msh";