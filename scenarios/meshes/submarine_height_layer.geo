...
// Problem specs
conduit_radius = 25;
depth_2D = 50; // Water depth in 2D portion
// depth_1D = 150; // Water depth in 1D portion
depth_1D = 0; // Water depth in 1D portion
angle_deg = 15;
...
msh_target_name = Sprintf("sub2_shallow_atm_%g_%g_%g.msh", conduit_radius, depth_1D, angle_deg);
// Tan of jet angle
