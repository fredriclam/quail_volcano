...
// Box dx control
dx_in1 = 37.5; // Refinement x2 // 75;     // In-box (region of interest) dx control -- chamber, dike
dx_in2 = 62.5; // Refinement x2 // 125    // In-box (region of interest) dx control -- thrust region
dx_mid1 = 125; // Refinement ~ // 150;   // Transition level 1
dx_mid2 = 200; // Refinement ~ // 275;   // Transition level 2
