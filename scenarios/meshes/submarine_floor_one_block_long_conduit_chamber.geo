...
L = 1150;
axischamber = 500;
ychamber_minoraxis = 150;
ychamber_majoraxis = 300;
ychamber_center = -L - ychamber_minoraxis * Sqrt(1 - a*a / (ychamber_majoraxis*ychamber_majoraxis));
ychamber_bottom = ychamber_center - ychamber_minoraxis;
...
Point(7) = {a+b, -b, 0, dx};
Point(8) = {a, -b, 0, dx};
Point(9) = {a, -L, 0, dx}; // Ellipse start
Point(10) = {0, -L, 0, dx};
Point(11) = {0, ychamber_center, 0, dx}; // Ellipse center
Point(12) = {ychamber_majoraxis, ychamber_center, 0, dx}; // Ellipse major axis 
Point(13) = {0, ychamber_bottom, 0, dx}; // Ellipse end point 
Point(14) = {0, theta1*r1 + (1.0 - theta1)*(-L), 0, dx}; // Point 1 along symmetry line
Point(15) = {0, theta2*r1 + (1.0 - theta2)*(-L), 0, dx}; // Point 2 along symmetry line
...
Save "submarine_one_block_1150conduit_chamber.msh";