...
Output = {'AutoPostProcess': False,
 'Prefix': '/scratch/users/kcoppess/pressureBC/sm0_15_cvf75/exponential_a10s/conduit_sub0',
...
BoundaryConditions = {'x1': {'BCType': 'PressureStableLinearizedInlet1D_genericFunc',
        'T_chamber': 1050,
        'cVFav': 0.4,
        'cVFfunc': exponential_timeSeries(TimeStepping["FinalTime"], 0.04, 9, 0.03, 10, 0.25),
        'chi_water': 0.03,
...
LinkedSolvers = [{'BoundaryName': 'comm1D_0_1',
  'DeckName': 'sm0_15_cvf75_exponential_a10s_conduit_sub1.py'}]
