...
Restart = {'File': '/scratch/users/kcoppess/gaussian_pulse_injection_NEWSMOOTH10/conduit_sub5_20419.pkl',
...
Output = {'AutoPostProcess': False,
 'Prefix': '/scratch/users/kcoppess/gaussian_pulse_injection_NEWSMOOTH10_r2/conduit_sub5',
...
LinkedSolvers = [{'BoundaryName': 'comm1D_5_6',
  'DeckName': 'restart_gaussianPulse_NEWSMOOTH10_conduit_sub6.py'}]
