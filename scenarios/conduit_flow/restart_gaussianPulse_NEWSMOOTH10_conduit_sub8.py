...
Restart = {'File': '/scratch/users/kcoppess/gaussian_pulse_injection_NEWSMOOTH10/conduit_sub8_20420.pkl',
...
Output = {'AutoPostProcess': False,
 'Prefix': '/scratch/users/kcoppess/gaussian_pulse_injection_NEWSMOOTH10_r2/conduit_sub8',
...
LinkedSolvers = [{'BoundaryName': 'comm1D_8_9',
  'DeckName': 'restart_gaussianPulse_NEWSMOOTH10_conduit_sub9.py'}]
