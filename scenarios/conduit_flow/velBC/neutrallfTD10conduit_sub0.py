...
Output = {'AutoPostProcess': False,
 'Prefix': '/scratch/users/kcoppess/ODEsteadyStateTD10_lfneutral/conduit_sub0',
...
BoundaryConditions = {'x1': {'BCType': 'VelocityInlet1D_neutralSinusoid',
        'T_chamber': 1050,
        'freq': 0.125,
...
LinkedSolvers = [{'BoundaryName': 'comm1D_0_1', 'DeckName': 'neutrallfTD10conduit_sub1.py'}]

TimeStepping = {'FinalTime': 1200,
 'InitialTime': 0.0,
 'NumTimeSteps': 16800000,
 'TimeStepper': 'RK3SR'}
