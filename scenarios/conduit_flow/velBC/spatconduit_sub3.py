...
Output = {'AutoPostProcess': False,
 'Prefix': '/scratch/users/kcoppess/ODEsteadyState/spatconduit10_sub3',
...
InitialCondition = {'Function': 'SteadyState',
 ...
 'yA': 1e-07,
 'yC': lambda t:  0.4 * (1.1 - 0.1 * np.cos(2*np.pi*0.5*t)),
 'yCMin': 1e-05,
 'yWt': lambda t: 0.03 * (1 - 0.4) / (1 + 0.03),
 'yWvInletMin': 1e-05}
...
LinkedSolvers = [{'BoundaryName': 'comm1D_3_4', 'DeckName': 'spatconduit_sub4.py'}]
