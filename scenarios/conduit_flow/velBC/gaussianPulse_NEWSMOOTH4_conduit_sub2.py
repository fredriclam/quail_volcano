...
Output = {'AutoPostProcess': False,
 'Prefix': '/scratch/users/kcoppess/gaussian_pulse_injection_NEWSMOOTH4/conduit_sub2',
...
InitialCondition = {'Function': 'SteadyState',
 ...
 'tau_d': 10.0,
 'tau_f': 1.0,
 'x_global': np.unique(np.hstack([np.linspace(-1.150e+03, -9.000e+02, 1001), np.linspace(-9.000e+02, -6.500e+02, 1001), np.linspace(-6.500e+02, -4.000e+02, 1001), np.linspace(-4.000e+02, -1.500e+02, 1001)])),
 'yA': 1e-07,
 'yC': lambda t: 0.4,
 'yCMin': 1e-05,
...
LinkedSolvers = [{'BoundaryName': 'comm1D_2_3',
  'DeckName': 'gaussianPulse_NEWSMOOTH4_conduit_sub3.py'}]
