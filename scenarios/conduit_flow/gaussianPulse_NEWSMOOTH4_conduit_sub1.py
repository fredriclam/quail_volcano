...
Output = {'AutoPostProcess': False,
 'Prefix': '/scratch/users/kcoppess/gaussian_pulse_injection_NEWSMOOTH4/conduit_sub1',
...
LinkedSolvers = [{'BoundaryName': 'comm1D_1_2',
  'DeckName': 'gaussianPulse_NEWSMOOTH4_conduit_sub2.py'}]
