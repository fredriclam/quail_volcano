...
Output = {'AutoPostProcess': False,
 'Prefix': '/scratch/users/kcoppess/pressureBC/sm0_15_cvf75/fractal8s_diffSEED/conduit_sub0_seed4',
...
BoundaryConditions = {'x1': {'BCType': 'PressureStableLinearizedInlet1D_genericFunc',
        'T_chamber': 1050,
        'cVFav': 0.4,
        'cVFfunc': fractal_timeSeries(1200, 0.04, 4, CH, 0.125),
        'chi_water': 0.03,
        'p_chamber': 40000000.0,
        'trace_arho': 2.6000000000000002e-05},
 'x2': {'BCType': 'MultiphasevpT1D1D', 'bkey': 'comm1D_0_1'}}

LinkedSolvers = [{'BoundaryName': 'comm1D_0_1', 'DeckName': 'seed4_conduit_sub1.py'}]
