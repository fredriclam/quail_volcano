...
Output = {'AutoPostProcess': False,
 'Prefix': '/scratch/users/kcoppess/pressureBC/sm0_15_cvf75/fractal8s_diffSEED/conduit_sub1_seed4',
...
LinkedSolvers = [{'BoundaryName': 'comm1D_1_2', 'DeckName': 'seed4_conduit_sub2.py'}]
