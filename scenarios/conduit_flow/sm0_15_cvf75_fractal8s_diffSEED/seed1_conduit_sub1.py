...
Output = {'AutoPostProcess': False,
 'Prefix': '/scratch/users/kcoppess/pressureBC/sm0_15_cvf75/fractal8s_diffSEED/conduit_sub1_seed1',
...
LinkedSolvers = [{'BoundaryName': 'comm1D_1_2', 'DeckName': 'seed1_conduit_sub2.py'}]
