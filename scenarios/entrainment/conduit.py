...
output_prefix = "coreblowout5A_25_150_15"
output_prefix = "coreblowout5B_25_150_15"
output_prefix = "coreblowout6B_25_50_15"
output_prefix = "coreblowout7B_25_150_15"
output_prefix = "coreblowout7R_25_150_15"
output_prefix = "coreblowout7D_25_150_15"
output_prefix = "coreblowout7R2_25_150_15"
# output_prefix = "coreblowout7D2_25_150_15"
output_prefix = "coreblowout8E_25_50_15"
output_prefix = "coreblowout8F_25_150_15"
output_prefix = "coreblowout8G_25_150_15"
output_prefix = "coreblowout8H_25_150_15"

# Key parameters
hsurf = 0.0               # Height of top boundary
hwm = -150 # -150                # Height of vent *************** (NEGATIVE)
conduit_radius = 25       # 1D cross-sectional area ***********
mu0 = 1e5                 # Viscosity (Pa s) if constant viscosity model
coeff_entrainment = 0.1   # Entrainment coefficient
...
T_magma = 1100 + 273.15
T_water = 300
T_porous = 600 # 1273.15 # 600 #  + 273.15
porosity = 1 # 0.5 # 0.3 # in premix region
...
Output = {'AutoPostProcess': False,
  ...
  'WriteInterval': 200, # 25,
}

TimeStepping = {
	"InitialTime" : 0.0,
	"FinalTime" : 10, # 20,
	"NumTimeSteps" : 10*1000, # 20*1000,
	"TimeStepper" : "FE",
}
