...
coreleak1J_25_50_15: T_porous 773.15, hwm -50 to -150 (matched); porosity 0.85 to 0.9 ; WriteInterval 100 to 50 IN BOTH! 30 s -> 60 s
coreleak1K_25_50_15: T_porous 773.15, hwm -150 to -50; porosity remains 0.9 ; Still WriteInterval 50, 60 s
fork: **** coreleak1L_25_50_15 ****: T_porous 773.15, hwm -50 to -0.001; porosity remains 0.9 ; Still WriteInterval 50, 60 s
fork: **** coreleak1O_25_50_15 ****: T_porous 473.15, hwm -50; porosity 0.99 ; Still WriteInterval 50, 60 s
...
output_prefix = "coreleak1O_25_50_15"
...
T_magma = 1100 + 273.15
T_water = 300
T_porous = 200+273.15 # 1273.15 # 600 #  + 273.15
...
if use_1D2D_link:
  ...
  LinkedSolvers = [{'BoundaryName': 'comm2D1D',
                  'DeckName': 'vent_region_cfork2.py'}]
