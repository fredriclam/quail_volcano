...
Output = {'AutoPostProcess': False,
 'Prefix': '/scratch/users/kcoppess/pressureBC/sm0_15_cvf75/fractal8s_diffSEED/conduit_sub4_seed1',
...
LinkedSolvers = [{'BoundaryName': 'comm1D_4_5', 'DeckName': 'seed1_conduit_sub5.py'}]
