...
Output = {'AutoPostProcess': False,
 'Prefix': '/scratch/users/kcoppess/pressureBC/sm0_15_cvf75/fractal8s_diffSEED/conduit_sub2_seed3',
...
LinkedSolvers = [{'BoundaryName': 'comm1D_2_3', 'DeckName': 'seed3_conduit_sub3.py'}]
