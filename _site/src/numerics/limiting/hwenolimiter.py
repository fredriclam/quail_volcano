...
class HWENO(base.LimiterBase):
	'''
	Runge-Kutta discontinuous Galerkin method with a simple and compact Hermite
  WENO limiter https://doi.org/10.4208/cicp.070215.200715a
	...
	'''
	COMPATIBLE_PHYSICS_TYPES = [general.PhysicsType.MultiphasevpT, 0] # Dummy 0
